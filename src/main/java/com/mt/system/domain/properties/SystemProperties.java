...
/**
 * 读取application.properties文件 spring.profiles.active为环境：dev,test,prod
 * 设置成相应的环境，则加载相应properties，如application-test.properties、application-prod.properties....... 其中检查带有prefix的词头，最后则为属性
 */
@Component
