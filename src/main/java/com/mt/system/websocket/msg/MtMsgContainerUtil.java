...
/**
 * Created with IDEA author: chenpan Date:2020/5/26 Time:15:27 ConcurrentHashMap是线程安全的，而HashMap是线程不安全的
 */
public class MtMsgContainerUtil {
    // 记录连接对象(公司-连接对象）
    private static ConcurrentHashMap<String, ConcurrentHashMap<String, MtSession>> mtMsgSessionMap =
        new ConcurrentHashMap<>();
    // 记录服务器向客户端发送消息(公司-消息对象）
    private static ConcurrentHashMap<String, ConcurrentHashMap<String, BaseBuilder<PushMessage>>> mtMsgPushMap =
        new ConcurrentHashMap<>();
    // 记录接收消息(公司-消息对象）
    private static ConcurrentHashMap<String, ConcurrentHashMap<String, BaseBuilder<ReceiveMessage>>> mtMsgReceiveMap =
        new ConcurrentHashMap<>();
    // 类型终端，PC、APP、H5
    ...
    public static ConcurrentHashMap<String, ConcurrentHashMap<String, BaseBuilder<ReceiveMessage>>>
        getMtMsgReceiveMap() {
